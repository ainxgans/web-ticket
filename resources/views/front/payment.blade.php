        ...
        <div class="flex flex-col rounded-[30px] p-5 gap-[14px] bg-white">
            ...
            <div class="flex items-center justify-between">
                ...
                <p class="font-semibold text-sm leading-[21px]">
                    Rp{{number_format($booking['sub_total'],0,',','.')}}</p>
            </div>
            <div class="flex items-center justify-between">
            ...
            <div class="flex flex-col gap-[6px]">
                ...
                <div class="grid grid-cols-2 gap-[10px]">
                    <label for="transfer" class="relative group">
                        ...
                        <input type="radio" name="payment-method" id="transfer" class="absolute top-1/2 left-1/2 -z-10"
                               required>
                    </label>
                    <label for="credit" class="relative group">
                        ...
                        <input type="radio" name="payment-method" id="credit" class="absolute top-1/2 left-1/2 -z-10"
                               required>
                    </label>
                </div>
            </div>
