            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="relative flex items-center w-full h-[480px] shrink-0 bg-[#13181D] overflow-hidden">
                        <img src="{{Storage::url($ticket->thumbnail)}}" class=" absolute w-full
                                 h-full
                ...
                @forelse($ticket->photos as $itemPhoto)
                    <div class="swiper-slide">
                        <div class="relative flex items-center w-full h-[480px] shrink-0 bg-[#13181D] overflow-hidden">
                            <img src="{{Storage::url($itemPhoto->photo)}}" class=" absolute w-full
                                 h-full
                                 object-cover" alt="thumbnail">
                        </div>
                    </div>
            ...
            <div class="flex items-center justify-between rounded-3xl p-[10px] pr-[14px] bg-[#F8F8F9]">
                <div class="flex items-center gap-[14px]">
                    <div class="w-[60px] h-[60px] rounded-[20px] overflow-hidden">
                        <img src="{{Storage::url($ticket->seller->photo)}}" class=" w-full h-full
                             object-cover">
                    </div>
                    <div>
            ...
            <div class="w-full h-[200px] overflow-hidden">
                <div id="embedded-map-display" class="w-full h-full">
                    <iframe class="w-full h-full" frameborder="0"
                            src="https://www.google.com/maps/embed/v1/place?q=singapore&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"></iframe>
                </div>
            </div>
