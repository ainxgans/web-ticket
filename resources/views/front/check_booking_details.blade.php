...
<div class="relative flex flex-col w-full min-h-screen max-w-[640px] mx-auto bg-[#F8F8F9]">
    ...
    <main class="relative flex flex-col w-full px-4 gap-[18px] mt-5 pb-[30px] overflow-x-hidden">
            ...
            <div class="flex items-center gap-[14px]">
                ...
                <div class="flex flex-col gap-[6px]">
                    ...
                    <p class="font-bold text-sm leading-[21px] text-[#F97316]">
                        Rp{{number_format($bookingDetails->ticket->price,0,',','.')}}</p>
                </div>
            </div>
        ...
        <div class="relative w-[361px] h-[504px] shrink-0 mx-auto overflow-hidden">
            <img src="{{asset('/assets/images/backgrounds/receipt.svg')}}" class="absolute w-full h-full object-contain"
                 alt="background">
                ...
                <div class="flex flex-col gap-[14px] shrink-0 h-full">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        @if($bookingDetails->is_paid)
                            <p class="w-fit rounded-full p-[6px_12px] bg-[#07B704] font-bold text-xs leading-[18px] text-white">
                                SUCCESS</p>
                        @else
                            <p class="w-fit rounded-full p-[6px_12px] bg-[#13181D] font-bold text-xs leading-[18px] text-white">
                                PENDING</p>
                        @endif
                    </div>
                </div>
